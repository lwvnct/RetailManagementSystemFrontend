...
export interface ApiOrdersByStoreOrdersByStore
  extends Struct.CollectionTypeSchema {
  collectionName: 'orders_by_stores';
  info: {
    description: '';
    displayName: 'NULL';
    pluralName: 'orders-by-stores';
    singularName: 'orders-by-store';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    contactNumber1: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::orders-by-store.orders-by-store'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    ordered_item: Schema.Attribute.Relation<
      'oneToOne',
      'api::ordered-item.ordered-item'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    sales_by_stores: Schema.Attribute.Relation<
      'manyToMany',
      'api::sales-by-store.sales-by-store'
    >;
    sales_history_by_stores: Schema.Attribute.Relation<
      'manyToMany',
      'api::sales-history-by-store.sales-history-by-store'
    >;
    sales_records: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiSalesByStoreSalesByStore
  extends Struct.CollectionTypeSchema {
...
export interface ApiSalesHistoryByStoreSalesHistoryByStore
  extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::orders-by-store.orders-by-store': ApiOrdersByStoreOrdersByStore;
      'api::product.product': ApiProductProduct;
      'api::sales-by-store.sales-by-store': ApiSalesByStoreSalesByStore;
      'api::sales-history-by-store.sales-history-by-store': ApiSalesHistoryByStoreSalesHistoryByStore;
